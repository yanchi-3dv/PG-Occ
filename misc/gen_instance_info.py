...
parser.add_argument('--gts-root', default='data/nuscenes/gts')
parser.add_argument('--output-dir', default='data/nuscenes/gts_panoptic')
parser.add_argument('--version', default='v1.0-trainval')
args = parser.parse_args()

token2path = {}
for gt_path in glob.glob(os.path.join(args.gts_root, '*/*/*.npz')):
